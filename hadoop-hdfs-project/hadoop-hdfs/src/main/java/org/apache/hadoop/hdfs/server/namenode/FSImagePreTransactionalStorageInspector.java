...
class FSImagePreTransactionalStorageInspector extends FSImageStorageInspector {
   ...
   */
  @SuppressWarnings("objectconstruction:required.method.not.called") // FP @EnsuresCalledMethodsVarArgs/@EnsuresCalledMethods: can't verify that cleanupWithLogger() closes in (validated)
