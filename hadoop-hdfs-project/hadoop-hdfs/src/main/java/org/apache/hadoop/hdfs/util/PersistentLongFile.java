...
public class PersistentLongFile {
  ...
  @SuppressWarnings("objectconstruction:required.method.not.called") // FP @EnsuresCalledMethodsVarArgs/@EnsuresCalledMethods: for some reason we couldn't verify that cleanupWithLogger closes br (validated)
