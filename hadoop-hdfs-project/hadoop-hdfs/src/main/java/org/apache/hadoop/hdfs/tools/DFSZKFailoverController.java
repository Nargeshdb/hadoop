...
public class DFSZKFailoverController extends ZKFailoverController {
   ...
   */
  @SuppressWarnings("objectconstruction:required.method.not.called") // FP @EnsuresCalledMethodsIf limitation: can’t handle with EnsuresCalledMethodsIf because the boolean is passed as a parameter (validated)
