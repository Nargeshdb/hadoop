...
public final class FSImageFormatPBINode {
  ...
  public final static class Loader {
    ...
    @SuppressWarnings("objectconstruction:required.method.not.called") //TP: loadINodeSectionHeader is called outside any try block and if it throws, ins won't be closed)
