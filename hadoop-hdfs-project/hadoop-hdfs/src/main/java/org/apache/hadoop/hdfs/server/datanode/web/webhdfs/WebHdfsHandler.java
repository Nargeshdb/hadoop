...
public class WebHdfsHandler extends SimpleChannelInboundHandler<HttpRequest> {
  ...
  @SuppressWarnings("objectconstruction:required.method.not.called") // TP: out remains open in possible exceptional exit due to new URI(HDFS_URI_SCHEME, nnId, path, null, null) (validated)
