...
public class ReplicaOutputStreams implements Closeable {
   ...
   * and a checksum.
   */
  @SuppressWarnings({"mustcall:assignment.type.incompatible","objectconstruction:required.method.not.called"}) // FP Tempvar for TypeCastNode: we should define tempvar for TypeCastNode (validated)
